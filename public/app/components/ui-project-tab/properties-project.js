...
const PropertiesProject = ({ project, onNameChange, onWindowChange }) => (
  <div>
    ...
    <table>
      <tbody>
        ...
        <tr>
          ...
          <td><WindowSelectorContainer project={project.uid} window={project.defaultWindow} onWindowChange={onWindowChange} /></td>
        </tr>
      </tbody>
    </table>
  </div>
